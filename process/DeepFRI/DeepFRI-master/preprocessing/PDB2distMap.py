...
if __name__ == '__main__':
    ...
    parser.add_argument('-seqres', type=str, default='./data/nrPDB-GO_2019.06.18_sequences.fasta', help="PDB chain seqres fasta.")
    parser.add_argument('-num_threads', type=int, default=20, help="Number of threads (CPUs) to use in the computation.")
    parser.add_argument('-bc', type=str,default='./data/nrPDB-GO_2019.06.18_test.csv', help="Clusters of PDB chains computd by Blastclust.")
