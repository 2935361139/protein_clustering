...
if __name__ == "__main__":
    ...
    # 定义输出目录
    output_dir = 'D:/bjfu/GNN-transformer/protein_cluster/output'
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    # 加载数据集
    train_dataset, test_dataset, full_dataset = load_datasets(
        'D:/bjfu/GNN-transformer/protein_cluster/data/matrix/aftermatrix',
        target_size=(256, 256))
    ...
    multi_label_tsv = "D:/bjfu/GNN-transformer/protein_cluster/data/Pfam-zhushi/output_labels_top50.tsv"
