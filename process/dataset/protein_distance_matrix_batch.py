...
def main():
    # Step 1: Load V.dahliae sequences
    fasta_file = "D:/bjfu/GNN-transformer/protein_cluster/data/fasta/nrAF_PDB_train_sequences.fasta"  # 请替换为您的FASTA文件路径
    fasta_dict = load_vdia_sequences(fasta_file)

    # Step 2: Process PDB folder with the BLAST CSV
    pdb_folder = "D:/bjfu/GNN-transformer/protein_cluster/data/pdb/"        # 请替换为您的PDB文件夹路径
    output_folder = "D:/bjfu/GNN-transformer/protein_cluster/data/matrix/aftermatrix/" # 请替换为您希望输出的距离矩阵文件夹路径
    blast_result_file = "D:/bjfu/GNN-transformer/protein_cluster/data/csv/v3.csv"  # 请替换为您的CSV文件路径
