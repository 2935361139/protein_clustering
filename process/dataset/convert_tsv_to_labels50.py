...
if __name__ == "__main__":
    # 设置输入和输出路径
    tsv_input = "D:/bjfu/GNN-transformer/protein_cluster/data/Pfam-zhushi/output_labels.tsv"
    tsv_output = "D:/bjfu/GNN-transformer/protein_cluster/data/Pfam-zhushi/output_labels_top-10.tsv"
