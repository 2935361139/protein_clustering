...
from network.DeepFRI import DeepFRI
from network.utils import seq2onehot
from network.utils import load_GO_annot, load_EC_annot
...
if __name__ == "__main__":
    ...
    parser.add_argument('-gc', '--gc_layer', type=str, default='GraphConv', choices=['GraphConv', 'MultiGraphConv', 'SAGEConv', 'ChebConv', 'GAT', 'NoGraphConv'],
                        help="Graph Conv layer.")
    parser.add_argument('-e', '--epochs', type=int, default=200, help="Number of epochs to train.200")
    parser.add_argument('-bs', '--batch_size', type=int, default=64, help="Batch size---64.")
    parser.add_argument('-pd', '--pad_len', type=int, default=160, help="Padd length (max len of protein sequences in train set).")
    ...
    parser.add_argument('--train_tfrecord_fn', type=str, default="", help="Train tfrecords.")
    parser.add_argument('--valid_tfrecord_fn', type=str, default="", help="Valid tfrecords.")
    parser.add_argument('--annot_fn', type=str, default="", help="File (*tsv) with GO term annotations.")
    parser.add_argument('--test_list', type=str, default="", help="File with test PDB chains.")
    ...
    Y_true = []
    proteins = []
    path = 'D:/bjfu/GNN-transformer/protein-predictor/data/output-npz/'
